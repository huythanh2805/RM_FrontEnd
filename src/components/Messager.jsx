      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div className="messagerBody relative w-full h-[440px] pr-2 overflow-y-scroll ">
            ...
            <div className="relative w-full ">
                <input type="text" className="relative px-3 py-3 w-full border focus-within:border-orange-1 focus-visible:outline-none rounded-lg"> 
