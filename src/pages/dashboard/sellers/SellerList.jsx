          ...
          <table className="min-w-full bg-white">
            <thead className="border-b border-[#d5d5d5] text-left text-sl font-semibold text-[#202224] uppercase tracking-wider">
              <tr>
                ...
                <th className="py-3 px-6 text-left text-sl font-semibold text-gray-700">Tên NCC</th>
                <th className="py-3 px-6 text-left text-sl font-semibold text-gray-700">Mã NCC</th>
                <th className="py-3 px-6 text-left text-sl font-semibold text-gray-700">Email</th>
                <th className="py-3 px-6 text-left text-sl font-semibold text-gray-700">SĐT</th>
            ...
            <tbody>
              {currentItems?.map((seller, index) => (
                <tr key={seller._id} className="bg-white border-b border-[#d5d5d5] hover:bg-gray-50 transition">
                  <td className="py-3 px-6 text-sl text-gray-800 break-words font-medium text-center">
                    {index + 1 + startIndex}
                  </td>
                  <td className="py-3 px-6 text-sl text-gray-800 break-words">{seller.name}</td>
                  <td className="py-3 px-6 text-sl text-gray-800 break-words">{seller.code}</td>
                  <td className="py-3 px-6 text-sl text-gray-800 break-words">{seller.email}</td>
                  <td className="py-3 px-6 text-sl text-gray-800 break-words">{seller.phone}</td>
                  <td className="py-3 px-6 text-sl text-gray-800 break-words">{seller.address}</td>
