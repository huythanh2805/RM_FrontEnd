...
const SetComboAdd = () => {
  ...
  const [dishes, setDishes] = useState([]); // Sản phẩm trong menu
  const [isMenu, setIsMenu] = useState(false);
  const [selectDish, setSelectDish] = useState([]); // Sản phẩm đã chọn trong menu
  ...
  return (
    <div className="w-full min-h-screen bg-[#f5f6fa]">
      <div className="px-5 py-2">
        <h2 className="text-[32px] font-semibold mb-4">Thêm combo</h2>
