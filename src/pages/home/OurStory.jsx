    ...
    <div className="flex flex-wrap items-start justify-between py-12 px-6 lg:px-20">
      ...
      <div className="w-full lg:w-1/2 lg:pl-8 mt-8 lg:mt-0 flex flex-col items-center">
        ...
        <p className="text-gray-800 mb-6 text-center">
          Tại Golden Fork, mỗi món ăn đều là một tác phẩm nghệ thuật, được chế
          biến từ những nguyên liệu tươi ngon nhất. Chúng tôi tự hào mang đến
          cho thực khách không chỉ những bữa ăn ngon miệng mà còn là những trải
          nghiệm đáng nhớ. Với một câu chuyện đầy đam mê và sự sáng tạo, chúng
          tôi đã xây dựng nhà hàng này để mang đến cho bạn không gian ấm cúng,
          nơi bạn có thể thưởng thức ẩm thực đa dạng từ khắp nơi trên thế giới.
        </p>
        <Link to={"/about"}>
