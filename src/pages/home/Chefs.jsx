...
function Chefs() {
  ...
  return (
    <section>
      ...
      <div className="mx-auto relative sm:w-[380px] md:w-[650px] lg:w-[768px] xl:w-[1136px]">
        <Swiper
          effect={"coverflow"}
          coverflowEffect={{
            rotate: 0,
        ...
        <div className="swiper-chef_button-prev slider-arrow absolute z-20 top-[50%]  left-[-100px] w-fit hidden lg:block">
          <div className="flex items-center group">
            <div className="min-w-10 min-h-10 border group-hover:border-orange-1 flex items-center justify-center rounded-full shadow-main_shadow shadow-black/10 cursor-pointer active:shadow-inner">
